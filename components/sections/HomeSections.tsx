...
const stats = [
  { value: 24, suffix: "/7", label: "Always Open", icon: Clock },
  { value: 12, suffix: "+", label: "Cities Served", icon: MapPin },
  { value: 9, suffix: "", label: "Core HVAC Services", icon: Wrench },
  { value: 1, suffix: "", label: "Local Team You Can Call", icon: ThumbsUp },
];
    ...
    <AnimatedSection className="relative overflow-hidden bg-grey/50 px-5 py-24 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <ButtonLink href={siteConfig.socials.google} variant="ghost" size="lg">
    ...
    <AnimatedSection className="relative overflow-hidden bg-grey/40 px-5 py-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.3fr_0.7fr] lg:items-start">
        <div className="relative overflow-hidden rounded-4xl bg-navy shadow-glass">
          <GoogleMapEmbed height={440} className="h-[440px] w-full" />
        </div>
        ...
        <div>
          <SectionHeading
            ...
            subtitle={`${siteConfig.serviceAreaLabel}. Call to confirm your location.`}
          />
